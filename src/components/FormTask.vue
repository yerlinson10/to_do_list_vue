                ...
                <FormIte>
                    ...
                    <FormControl>
                        <Input type="text" placeholder="Title task" v-bind="componentField"
                            class="col-span-3 dark:bg-[#030712] ring-offset-background " v-model="title"/>
                    </FormControl>
                    <FormDescription>
            ...
            <FormField v-slot="{ componentField }" name="description">
                <FormIte >
                    ...
                    <FormControl>
                        ...
                        class="dark:bg-[#030712] col-span-3 " v-model="description"></Textarea>
                    </FormControl>
                    <FormDescription>
...
const onSubmit = (values, { resetForm }) => {
    TaskStore.saveTask(title.value, description.value)
